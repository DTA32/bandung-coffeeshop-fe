  ...
  return (
    <main className="flex-1 md:px-8 py-12">
      <section className="mx-auto max-w-3xl rounded-2xl p-6 sm:p-8 text-forest flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="flex flex-col gap-3 text-bark">
            <li>
              ...
              Middle, atau tindakan lain yang kami catat sebagai event
              analitik); metrik kecepatan muat dan responsivitas halaman
              (&quot;Web Vitals&quot;); informasi umum perangkat dan browser
              (jenis, ukuran layar, bahasa); dan perkiraan lokasi setingkat kota
              yang diperoleh dari alamat IP-mu.
            </li>
            <li>
              <span className="font-semibold text-forest">
                Diagnostik error.
              ...
              memuat data pribadi, meskipun alamat halaman terkadang bisa
              muncul.
            </li>
            <li>
              <span className="font-semibold text-forest">Log server.</span>{' '}
              Server kami mencatat data permintaan teknis seperti alamat IP, URL yang
              diminta, waktu, status respons, dan jenis browser untuk
        ...
        <div className="flex flex-col gap-3">
          <h2 className="font-semibold">
            2. Data lokasi (hanya dengan izinmu)
          </h2>
          <p className="text-bark">
            Fitur seperti &quot;cari kafe terdekat&quot; dapat menggunakan
            lokasi perangkatmu. Browser-mu akan selalu meminta izin terlebih
            dahulu, dan kamu bisa menolak. Saat kamu mengizinkannya, koordinatmu
            hanya digunakan untuk mencari kafe terdekat, bukan untuk
            mengidentifikasimu.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-bark">
            ...
            menghapus cookie di browser-mu (lihat &quot;Pilihanmu&quot; di
            bawah).
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-bark">
            ...
            bagaimana situs benar-benar digunakan, sehingga menemukan kafe berikutnya 
            menjadi sedikit lebih mudah setiap kali berkunjung. Kami juga menggunakannya
            untuk menjaga situs tetap aman. Kami tidak menjual datamu,
            menampilkan iklan, atau membuat profil iklan.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-bark">
            ...
            data sebagai bagian dari penyajian situs. Masing-masing menangani
            data berdasarkan kebijakannya sendiri.
          </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-bark">
            ...
            tujuan di atas; Google menyimpan data analitik sesuai pengaturan
            yang kami konfigurasikan dan kebijakannya sendiri.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="flex flex-col gap-2 text-bark list-disc pl-5">
            ...
            <li>
              Menolak atau mencabut akses lokasi kapan saja di browser-mu.
            </li>
            <li>
              Email{' '}
              ...
              untuk menanyakan data yang kami simpan atau meminta
              penghapusannya.
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-bark">
            BDGCafé tidak ditujukan untuk anak-anak, dan kami tidak dengan
            sengaja mengumpulkan data mereka.
          </p>
        </div>
