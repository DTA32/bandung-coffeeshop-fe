      ...
      <section className="mx-auto max-w-3xl rounded-2xl p-6 sm:p-8 text-forest flex flex-col gap-10">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-lg text-bark">
            BDGCafé is an independent guide to cafés in Bandung, run as a
            personal project. This page explains what information the site
            collects, why, and the choices you have.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="flex flex-col gap-3 text-bark">
            <li>
              ...
              language); and an approximate, city-level location derived from
              your IP.
            </li>
            <li>
              <span className="font-semibold text-forest">
              ...
              When something breaks, we record technical details to fix it
              (error message and stack trace), the page it happened on, and your
              browser&apos;s user-agent. This isn&apos;t meant to contain
              personal data, though a page address could occasionally appear.
            </li>
            <li>
              <span className="font-semibold text-forest">Server logs.</span>{' '}
              Our server records technical request data, like IP address, requested
              URL, timestamps, response status, and browser type, to operate
              the site and protect it against abuse and attacks.
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-bark">
            Features like &quot;find nearby cafés&quot; can use your device location. 
            Your browser always asks first, and you can decline. When you allow it, 
            your coordinates are used only to find nearby cafés, not to identify you.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-bark">
            ...
            doesn&apos;t use cookies. We don&apos;t use cookies for advertising
            or cross-site tracking. You can control or clear cookies in your
            browser (see &quot;Your choices&quot; below).
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-bark">
            ...
            around how the site is really used, so finding your next café gets
            a little easier each visit. We also use it to keep the site safe and
        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="flex flex-col gap-2 text-bark list-disc pl-5">
            ...
            <li>
              ...
              map tiles for interactive maps.{' '}
              <a
                className={LINK}
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-bark">
            We keep analytics and log data only as long as needed for the
            purposes above; Google retains analytics data according to our
            configured settings and its own policies.
          </p>
        </div>
