    ...
    <section className="mx-auto max-w-3xl rounded-2xl p-6 sm:p-8 text-forest flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col text-bark gap-2">
          ...
          <p>
            Finding the right one used to mean scrolling through my Google Maps
            list and re-reading the reviews I&apos;d written, then scrolling all
            over again whenever I needed a café in a specific area.
          </p>
          <p>
            It got worse when meeting friends. To search for the fairest spot
            for everyone, I&apos;d look up the midpoint on some old website that
            only shows the point itself (no cafe recommendations), then search
            for cafés around it and start re-reading reviews from scratch.
          </p>
          <p>
        ...
        <ul className="space-y-4">
          <li>
            ...
            <p className="text-bark">
              Currently in a specific neighborhood or near a landmark, and want
              to find a café nearby? Filter cafés by location and find the
              perfect spot without hassle.
            </p>
          </li>
          <li>
            <h3 className="font-semibold text-forest">Work-from-café scores</h3>
            <p className="text-bark">
          ...
          <li>
            ...
            <p className="text-bark">
              Not sure if it&apos;s open or worth the trip? Check opening hours,
              tags, and quick facts on each café&apos;s page before you head
              out.
            </p>
          </li>
        </ul>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col text-bark gap-1">
          <p>
            ...
            parking. Scores reflect a single visit (although on some cafe
            it&apos;s based on multiple visit) and personal taste, so treat them
            as a friend&apos;s recommendation, not a final verdict. Your
            experience may vary, and that&apos;s perfectly fine.
          </p>
          <p>
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-bark">
          BDGCafé is an independent project, made with care in Bandung. Found a
          café that deserves a spot, or noticed something wrong? I&apos;d love
          to hear from you at{' '}
          <a
