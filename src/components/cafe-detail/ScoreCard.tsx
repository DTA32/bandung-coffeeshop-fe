      ...
      <div className="flex justify-between gap-4">
        {overallScore &&
          <div className="flex flex-col gap-2">
            <span className="text-xs font-semibold text-bark">Overall Score</span>
        ...
        {wfcScore &&
          <div className={`flex flex-col gap-2 ${overallScore ? 'items-end' : 'items-start'}`}>
        ...
        {!overallScore && !wfcScore &&
          <div className="flex justify-center items-center h-16 w-full">
            <p className="text-sm leading-[1.7] m-0 text-bark"> No scores yet. </p>
          </div>
        }
      </div>
      {overallScore || wfcScore ?
