...
export default function CafeCard({cafe, showBorder = false}: { cafe: CafeListing, showBorder?: boolean }) {
    ...
    >
      ...
      <div className="flex flex-col gap-2 p-4 min-h-24">
        <div className="flex flex-col gap-1">
          <span className="font-semibold text-forest line-clamp-1">{cafe.name}</span>
          {cafe.area && (
